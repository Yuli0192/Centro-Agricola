...
Public Class InspeccionMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.InspeccionMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInspeccionMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InspeccionMes = New InspeccionMes
        rpt.Site = Me.Site
        Return rpt
    End Function
