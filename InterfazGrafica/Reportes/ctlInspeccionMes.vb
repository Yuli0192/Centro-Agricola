...
Public Class ctlInspeccionMes

    Private Sub ctlInspeccionMes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub pbReporte_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pbReporte.Click
        ...
        If resul Then
            Dim reporte As New InspeccionMes
            ...
            reporteInspeccion.ReportSource = reporte
            reporteInspeccion.Refresh()
        End If
    End Sub
