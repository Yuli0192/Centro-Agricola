...
Public Class OrdenesMensuales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.OrdenesMensuales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenesMensuales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenesMensuales = New OrdenesMensuales
        rpt.Site = Me.Site
        Return rpt
    End Function
