...
Public Class PermisoAuxPrue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.PermisoAuxPrue.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_codpermiso() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPermisoAuxPrue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PermisoAuxPrue = New PermisoAuxPrue
        rpt.Site = Me.Site
        Return rpt
    End Function
