...
Public Class OrdenesPendientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.OrdenesPendientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenesPendientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenesPendientes = New OrdenesPendientes
        rpt.Site = Me.Site
        Return rpt
    End Function
