...
Public Class OrdenesMesPrueba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.OrdenesMesPrueba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenesMesPrueba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenesMesPrueba = New OrdenesMesPrueba
        rpt.Site = Me.Site
        Return rpt
    End Function
