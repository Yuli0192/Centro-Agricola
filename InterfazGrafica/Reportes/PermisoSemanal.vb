...
Public Class PermisoSemanal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.PermisoSemanal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPermisoSemanal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PermisoSemanal = New PermisoSemanal
        rpt.Site = Me.Site
        Return rpt
    End Function
