...
Public Class ClientesExcluidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.ClientesExcluidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClientesExcluidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ClientesExcluidos = New ClientesExcluidos
        rpt.Site = Me.Site
        Return rpt
    End Function
