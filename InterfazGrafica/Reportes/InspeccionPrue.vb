...
Public Class InspeccionPrue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "InterfazGrafica.InspeccionPrue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedInspeccionPrue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InspeccionPrue = New InspeccionPrue
        rpt.Site = Me.Site
        Return rpt
    End Function
