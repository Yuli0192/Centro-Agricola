...
Public Class ctlListadoAuxProducto
    ...
    Private Sub ctlListadoAuxProducto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cargarProductos()
    End Sub
