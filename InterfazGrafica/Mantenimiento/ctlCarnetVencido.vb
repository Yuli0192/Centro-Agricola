...
Public Class ctlCarnetVencido
    ...
    Private Sub ctlCarnetVencido_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        limpiarForm()
        nombrarColumnas()
        invisible()
    End Sub
    ...
    Private Sub cargarSocios()
        Try
            ...
            _listaSocio = _gestor.buscarCarnetVencidos() 'asignar el resultado de la búsqueda devuelto por un método del Gestor
