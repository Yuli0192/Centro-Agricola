...
Public Class ctlBuscarPermisoAuxPendiente
    ...
    Private Sub ctlBuscarPermisoAuxPendiente_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtCriterio.Focus()
        limpiarForm()
        nombrarColumnas()
        invisible()
    ...
    Private Sub cargarPermisos()
        Try
            ...
            _listaPermiso = _gestor.listarPermisosAux() 'asignar el resultado de la búsqueda devuelto por un método del Gestor
    ...
    Private Sub buscarCriterioPermiso(ByVal pcriterio As String)
        Try
            ...
            _listaPermiso = _gestor.buscarPermisoPorCriterioAux(pcriterio) 'asignar el resultado de la búsqueda devuelto por un método del Gestor
