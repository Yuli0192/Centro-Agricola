...
Public Class ctlBuscarOrdenCancelada
    ...
    Private Sub ctlBuscarOrdenCancelada_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        txtCriterio.Focus()
        limpiarForm()
        nombrarColumnas()
        invisible()
    ...
    Public Sub nombrarColumnas()
        ...
        dgvOrden.Columns(6).HeaderText = "Fecha Vencio"
    ...
    Private Sub cargarOrdenes()
        Try
            ...
            _listaOrdenes = _gestor.listarOrdenesCanceladas() 'asignar el resultado de la búsqueda devuelto por un método del Gestor
    ...
    Private Sub buscarCriterioOrden(ByVal pcriterio As String)
        Try
            ...
            _listaOrdenes = _gestor.listarOrdenesCanceladasCriterio(pcriterio) 'asignar el resultado de la búsqueda devuelto por un método del Gestor
