...
Public Class PopupRegistrarFeriaAux
    Dim _gestor As New LogicaNegocio.ClsGestor
    'vamos a guardar en una variable esa pantalla.
    Dim _pantallaSocioConDatosAux As ctlRegistrarAuxiliar
    Dim _resul As Boolean

    Public Property PantallaSocioConDatosAux() As ctlRegistrarAuxiliar
        Get
            Return _pantallaSocioConDatosAux
        End Get
        Set(ByVal value As ctlRegistrarAuxiliar)
            _pantallaSocioConDatosAux = value
        End Set
    End Property
    ...
    Private Sub pbRegistrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pbRegistrar.Click
        ...
        If _resul = True Then
            ...
            Try
                ...
                Me._pantallaSocioConDatosAux.cargarFerias()
                Me.Hide()
